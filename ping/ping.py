import socket     #run->sudo python3 ping.py
import signal
import struct
from ctypes import *
...
def ipPacket():
    ...
    src = '192.168.231.129' #Change to your Ip address
    version=4
    tos=0
    lent=60
    iden=1188
    ...
    ip_pac=struct.pack('!BBHHHBBH4s4s',version,tos,lent,iden,off,ttl,proto,check,ip_saddr,ip_daddr)
